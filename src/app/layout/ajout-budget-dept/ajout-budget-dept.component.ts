...
@Component({
  selector: 'app-ajout-budget-dept',
  templateUrl: './ajout-budget-dept.component.html',
  styleUrls: ['./ajout-budget-dept.component.scss']
})
export class AjoutBudgetDeptComponent implements OnInit {
